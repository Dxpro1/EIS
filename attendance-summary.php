                                        ...
                                        <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1 align-self-center">
                                                        <h4 class="card-title">Attendance Summary Table</h4>
                                                    </div>
                                                    ...
                                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="filter-off-canvas" data-bs-backdrop="true" aria-labelledby="filter-off-canvas-label">
                                                        ...
                                                        <div class="offcanvas-body">
                                                            ...
                                                            <div>
                                                                <button type="button" class="btn btn-primary waves-effect waves-light" id="apply-attendance-summary-filter" data-bs-toggle="offcanvas" data-bs-target="#filter-off-canvas" aria-controls="filter-off-canvas">Apply Filter</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <table id="attendance-summary-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="all">Late (Minutes)</th>
                                                            <th class="all">No. of Undertime</th>
                                                            <th class="all">Undertime (Minutes)</th>
                                                            <th class="all">Attendance Adjustments</th>
                                                            <th class="all">Vacation Leave</th>
                                                            <th class="all">Leave without Pay</th>
                                                            <th class="all">Maternity Leave</th>
                                                            <th class="all">Paternity Leave</th>
                                                            <th class="all">Official Business (Paid)</th>
                                                            <th class="all">Official Business (Unpaid)</th>
                                                            <th class="all">Emergency Leave</th>
                                                            <th class="all">Sick Leave</th>
                                                            <th class="all">Madatory Leave</th>
